...
```
section 부분을 3가지로 나누어서 각 키워드에 맞는 요소들로 채워주었습니다.
AOS라는 라이브러리를 사용하여 애니메이션을 쉽게 만들어 주었습니다. 
먼저 flip은 뒤집기 애니메이션이 들어간 라이브러리 코드입니다. 
그리고 fade는 흐렸던 요소가 점점 선명해지는 코드입니다. 
